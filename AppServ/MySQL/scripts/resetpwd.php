...
function AppServCMD() {
	...
	exec ("C:\PROGRA~2\AppServ\MySQL\bin\mysql -e \"update mysql.user set authentication_string=PASSWORD('$input') where user = 'root';\"");
	exec ("C:\PROGRA~2\AppServ\MySQL\bin\mysqladmin -u root shutdown");
	sleep(3);
